...
**Before grid preview:**
**"You will now see all 16 objects you will be sorting at the same time — for reference only; just watch & don't memorize."** · `phase1_before_grid` · **Enter** ignored until **`PHASE13_BEFORE_GRID_MIN_SEC`** (**`TASK_DESCRIPTION.md`** timings).
...
**During sorting (gray hint on every trial):** **"Click where you want to place each object, then press Enter to confirm."**
...
**During trials — object question epoch:** **"What is the object?"** (shown after each object, for **`PHASE2_OBJECT_QUESTION_DURATION_SEC`**)
...
**After fixation:**
**"Click where you want to place each object, then press Enter to confirm."** · `phase3_instruction2c` (mini-grid inset)
