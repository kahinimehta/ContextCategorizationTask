...
| `tutorial_fallback_onset` | — | Fallback **tutorial** demo (**`script.md`**): **`trial_info: step=1, 2, 3, 4, 5a, or 5b`** when **`tutorial_video.mp4`** is absent or playback fails. **`step=2`** shows **`PHASE13_CLICK_ENTER_INSTRUCTION`** (**once** in demo); steps **2–4** timeline → **`tutorial_fallback_step{n}_*`**. Phase **1**/**3** instruction TTLs (**`phase1_instr3_*`**, **`phase3_instruction2c_*`**) and gray hint — unchanged in the sorting blocks. |
